...
export default function AboutPage() {
  return (
    <article className="prose prose-slate lg:prose-lg">
      <h1>About Harry</h1>
      <p>
        I'm an aerospace engineer turned decision technologist. I design and ship interactive tools that blend
      ...
      <p>
        I'm currently developing <strong>Deckide</strong> (decision decks for trade-offs) and <strong>SayVault</strong>
